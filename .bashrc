...
##### KRKA ######
# Reminder about cfg files:
# .bash_profile - just load .profile and .bashrc
# .profile - stuff needed for all shells, like $PATH
...
alias la='ls -A'
alias l='ls -CF'
alias clojure='java -cp /home/karka/clojure-1.8.0/clojure.jar /home/karka/clojure-1.8.0/clojure.main'
